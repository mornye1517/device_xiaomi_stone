...
git clone https://github.com/Fucking-Projekt/android_packages_apps_GameBar packages/apps/GameBar
...
git clone https://github.com/mornye1517/mornye_clang prebuilts/clang/host/linux-x86/clang-mornye --depth=1
